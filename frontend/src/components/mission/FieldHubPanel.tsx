...
export interface FieldHubPanelProps {
  /** poll result owned by the parent - the panel never opens a poll. */
...
/** field hub connection body - connect address, QR, live status, CA cert. */
export default function FieldHubPanel({
  status,
  onRefresh,
  checking = false,
  lastChecked = null,
